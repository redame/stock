...
elliott_analyze<-function(zigzag,ashi){
  tmp<-dbSendQuery(con,paste("select * from elliott where zigzag=",zigzag," and ashi='",ashi,"'",sep=""))
  ...
  for(i in 1:length(data.elliott$stockCode)){
    ...
    query<-paste("replace into elliott_analyze values('",stockCode,"',",zigzag,",'",date1,"','",date9,"','",ashi,"',",wave2_1,",",wave3_1,",",wave4_1,",",wave4_3,",",wave5_1,",",wave5_4,",",wavea_5,",",wavea_1,",",waveb_a,",",wavec_a,")",sep="")
    print(query)
...
zigzag<-0.01
ashi<-"d"
#tmp<-dbSendQuery(con,paste("select * from elliott_analyze where zigzag=",zigzag," and ashi='",ashi,"'",sep=""))
tmp<-dbSendQuery(con,paste("select * from elliott_analyze where  ashi='",ashi,"'",sep=""))
