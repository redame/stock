...
class Elliott:
    ...
    def __write_to_db(self,dates,prices):
        ...
        cursor.execute("replace into fintech.ptnPBElliott values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.stockCode,self.pb_term,dates[0],prices[0],dates[1],prices[1],dates[2],prices[2],dates[3],prices[3],dates[4],prices[4],dates[5],prices[5],dates[6],prices[6],dates[7],prices[7],dates[8],prices[8],self.ashi))
