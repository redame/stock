...
shinyUI(bootstrapPage(
  ...
  tags$div(
    HTML("<div align='center'><a href='../ptn_list/?ashi=d' class='btn btn-primary'><b>Daily</b></a>&nbsp;<a href='../ptn_list/?ashi=w' class='btn btn-primary'><b>Weekly</b></a>&nbsp;<a href='../ptn_list/?ashi=m' class='btn btn-primary'><b>Monthly</b></a></div>")
  ),
